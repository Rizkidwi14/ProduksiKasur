...
$laporan = query("SELECT * FROM laporanpengecekan ORDER BY id DESC");
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <h2>Laporan Pengecekan Produksi</h2>
      <div class="table-responsive">
        <table class="table table-striped table-sm text-center">
            <thead>
                <th>NO.</th>
                <th class="col-sm-1">ID Pengecekan</th>
                <th>Jenis Produk</th>
                <th>Kategori Produk</th>
                <th>Tanggal Pengecekan Produk</th>
                <th>Jumlah</th>
