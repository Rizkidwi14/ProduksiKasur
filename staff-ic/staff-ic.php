...
$bahanBaku = query("SELECT * FROM bahanbaku");
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <a class="btn btn-primary" href="tambahBahan.php" role="button">Tambah Data Bahan Baku</a>
      <div class="table-responsive">
        ...
        <table class="table table-striped table-sm fs-4">
          ...
          <tr>
            ...
            <td> <?= number_format($row["jumlahBahanBaku"]); ?> </td>
          </tr>
          <?php $i++; ?>
          <?php endforeach; ?>
        </table>
