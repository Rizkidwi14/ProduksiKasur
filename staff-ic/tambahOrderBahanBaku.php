...
if(isset($_POST["submit"])){
    if(tambahOrderBahanProduk($_POST) > 0 ) {
        echo "<script>
                alert ('Data Berhasil Disimpan');

                // document.location.href = 'tambahOrderBahanBaku.php';
              </script>
              ";
        } else {
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="pemesananBahanBaku.php">Kembali</a>
...
<div class="container-fluid">
  <div class="row">
    <main class="offset-md-3 col-lg-6 px-md-3">
        <h1 class="text-center">Order Bahan Baku</h1>
            ...
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                <table>
                    ...
                    <tr>
                        ...
                        <td align="right"> <input class="form-control " type="date" name="tanggal" required size="30px"> </td>
                    </tr>
                    <tr>
                        <td>Durasi Pengiriman Bahan Baku (Hari)</td>
                        <td align="right"> <input class="form-control " type="number" name="durasi" required size="30px"> </td>
                    </tr>
                </table>
