...
$bahanBaku = query("SELECT * FROM pemesananBahanBaku ORDER BY id DESC");
...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="staff-ic.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Data Pemesanan Bahan Baku</h2>
      <a class="btn btn-primary" href="tambahOrderBahanBaku.php" role="button">Tambah Pemesanan Bahan Baku</a>
      <div class="table-responsive">
        <table class="table table-striped table-sm fs-4 text-center">
          <thead >
